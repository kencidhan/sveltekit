...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-2da4f61a.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-2da4f61a.js", assets + "/_app/chunks/vendor-56c27031.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "manifest.json", "size": 444, "type": "application/json" }, { "file": "pwa-512x512.png", "size": 18707, "type": "image/png" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }, { "file": "svelte-welcome.png", "size": 360807, "type": "image/png" }, { "file": "svelte-welcome.webp", "size": 115470, "type": "image/webp" }],
  ...
  routes: [
    ...
    },
    {
      type: "page",
      pattern: /^\/user\/([^/]+?)\/?$/,
      params: (m) => ({ user_id: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/user/__layout.svelte", "src/routes/user/[user_id].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/user/__layout.svelte": () => Promise.resolve().then(function() {
    return __layout;
  }),
  "src/routes/user/[user_id].svelte": () => Promise.resolve().then(function() {
    return _user_id_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-5d49c956.js", "css": ["assets/pages/__layout.svelte-1fda6867.css"], "js": ["pages/__layout.svelte-5d49c956.js", "chunks/vendor-56c27031.js", "chunks/stores-d44e406a.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-76f44832.js", "css": [], "js": ["error.svelte-76f44832.js", "chunks/vendor-56c27031.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-aca6ee15.js", "css": ["assets/pages/index.svelte-b6f83df6.css"], "js": ["pages/index.svelte-aca6ee15.js", "chunks/vendor-56c27031.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-21101fe9.js", "css": ["assets/pages/about.svelte-bf4528fa.css"], "js": ["pages/about.svelte-21101fe9.js", "chunks/vendor-56c27031.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-34cb7b1b.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-34cb7b1b.js", "chunks/vendor-56c27031.js"], "styles": [] }, "src/routes/user/__layout.svelte": { "entry": "pages/user/__layout.svelte-01e28d6d.js", "css": [], "js": ["pages/user/__layout.svelte-01e28d6d.js", "chunks/vendor-56c27031.js"], "styles": [] }, "src/routes/user/[user_id].svelte": { "entry": "pages/user/[user_id].svelte-16bdd862.js", "css": [], "js": ["pages/user/[user_id].svelte-16bdd862.js", "chunks/vendor-56c27031.js", "chunks/stores-d44e406a.js"], "styles": [] } };
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			...
			<li class="${["svelte-t2wq17", $page.path === "/todos" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/todos"}" class="${"svelte-t2wq17"}">Todos</a></li>
			<li class="${["svelte-t2wq17", $page.path === "/user/100" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/user/1000"}" class="${"svelte-t2wq17"}">User</a></li></ul>
...
var U5Buser_idu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  $$unsubscribe_page();
  return `<h1>User Page</h1>
<p>Displaying information about user: ${escape($page.params.user_id)}</p>`;
});
var _user_id_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": U5Buser_idu5D
});
